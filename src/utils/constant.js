 ...
 */
export const MOODS = [
  { key: 'loved', label: 'Loved', score: 5 },
  { key: 'excited', label: 'Excited', score: 5 },
  { key: 'joyful', label: 'Joyful', score: 5 },
  { key: 'grateful', label: 'Grateful', score: 5 },
  { key: 'amazed', label: 'Amazed', score: 5 },
  { key: 'happy', label: 'Happy', score: 5 },
  { key: 'peaceful', label: 'Peaceful', score: 4 },
  { key: 'relaxed', label: 'Relaxed', score: 4 },
  { key: 'amused', label: 'Amused', score: 4 },
  { key: 'proud', label: 'Proud', score: 4 },
  { key: 'hopeful', label: 'Hopeful', score: 4 },
  { key: 'thoughtful', label: 'Thoughtful', score: 3 },
  { key: 'neutral', label: 'Neutral', score: 3 },
  { key: 'sleepy', label: 'Sleepy', score: 2 },
  { key: 'anxious', label: 'Anxious', score: 2 },
  { key: 'disappointed', label: 'Disappointed', score: 2 },
  { key: 'stressed', label: 'Stressed', score: 1 },
  { key: 'sad', label: 'Sad', score: 1 },
  { key: 'angry', label: 'Angry', score: 1 },
  { key: 'exhausted', label: 'Exhausted', score: 1 },
];
